...
* **Framework Cross-Walk:**
  ...
  - **MITRE D3FEND:** [`D3-MTC`](https://d3fend.mitre.org/) (Message Authentication), [`D3-HPA`](https://d3fend.mitre.org/) (Hardware Platform Authentication), [`D3-SFL`](https://d3fend.mitre.org/) (Sensor File Integrity Monitoring).
...
* **Framework Cross-Walk:**
  ...
  - **MITRE D3FEND:** [`D3-SVE`](https://d3fend.mitre.org/) (Schema Validation), [`D3-DLQ`](https://d3fend.mitre.org/) (Dead-Letter Queue Isolation), [`D3-RPL`](https://d3fend.mitre.org/) (Raw Payload Envelope Preservation).
...
* **Framework Cross-Walk:**
  ...
  - **MITRE D3FEND:** [`D3-WORM`](https://d3fend.mitre.org/) (Write-Once Media Storage), [`D3-CH`](https://d3fend.mitre.org/) (Cryptographic Hash Verification), [`D3-TSA`](https://d3fend.mitre.org/) (Timestamp Attestation).
...
* **Framework Cross-Walk:**
  ...
  - **MITRE D3FEND:** [`D3-IT`](https://d3fend.mitre.org/) (Isolated Execution / Dual-Plane Data Isolation), [`D3-LAM`](https://d3fend.mitre.org/) (Least-Privilege Access Mechanism), [`D3-MDA`](https://d3fend.mitre.org/) (Model Diversity & Dual-Model Arbitration).
...
* **Framework Cross-Walk:**
  ...
  - **MITRE D3FEND:** [`D3-ARA`](https://d3fend.mitre.org/) (Alert Rate Anomaly Detection), [`D3-BCA`](https://d3fend.mitre.org/) (Bayesian Correlation Analysis), [`D3-SND`](https://d3fend.mitre.org/) (Supernode Degree Dampening).
...
* **Framework Cross-Walk:**
  ...
  - **MITRE D3FEND:** [`D3-SMS`](https://d3fend.mitre.org/) (State Machine Security / Reachability Monotonicity), [`D3-BRC`](https://d3fend.mitre.org/) (Blast-Radius Constraint & Critical Asset Immunity), [`D3-BGO`](https://d3fend.mitre.org/) (Break-Glass Human Override & Master E-Stop).
...
* **Framework Cross-Walk:**
  ...
  - **MITRE D3FEND:** [`D3-LAM`](https://d3fend.mitre.org/) (Least-Privilege Access Mechanism), [`D3-MTC`](https://d3fend.mitre.org/) (Message Authentication), [`D3-IT`](https://d3fend.mitre.org/) (Isolated Execution).
...
* **Framework Cross-Walk:**
  ...
  - **MITRE D3FEND:** [`D3-CH`](https://d3fend.mitre.org/) (Cryptographic Hash Verification), [`D3-BCA`](https://d3fend.mitre.org/) (Bayesian Correlation Analysis), [`D3-MDA`](https://d3fend.mitre.org/) (Model Diversity & Dual-Model Arbitration), [`D3-DN`](https://d3fend.mitre.org/) (Decoy Network / Environment).
...
* **Framework Cross-Walk:**
  ...
  - **MITRE D3FEND:** [`D3-EOP`](https://d3fend.mitre.org/) (Execution Boundary / Sandboxing), [`D3-SLB`](https://d3fend.mitre.org/) (Semantic Loop Breaking & Resource Limiting), [`D3-IT`](https://d3fend.mitre.org/) (Isolated Execution).
...
| **AI-04** | **Model Denial of Service** | [`AML.T0029`](https://atlas.mitre.org/) (Denial of Service via Heavy Query) | [`LLM04`](https://owasp.org/www-project-top-10-for-large-language-model-applications/) | **Semantic Loop & Cost Circuit Breakers**: Max 8 tool hops, 180-second timeouts, sliding-window query hashing, and hard financial caps (\$2.50 per branch) prevent resource exhaustion. | **INV-06** (Bounded Autonomy)<br>[ADR-0017](/adr/0017-agent-fleet-control-plane-and-runtime-observability) |
...
| **AI-06** | **Excessive Agency** | [`AML.T0053`](https://atlas.mitre.org/) (Excessive Agency / Goal Hijacking) | [`LLM06`](https://owasp.org/www-project-top-10-for-large-language-model-applications/) | **Read-Only Capability Boundary**: Triage agents possess zero mutating infrastructure credentials. All containment actions require explicit response safety kernel evaluation. | **INV-05** (Least Capability)<br>[ADR-0004](/adr/0004-defensive-ai-runtime-and-prompt-injection-firewall) |
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **THR-T1**: Sensor Evasion / Log Blinding | **S / T** | [`T1562.001`](https://attack.mitre.org/techniques/T1562/001/) (Impair Defenses)<br>[`T1070`](https://attack.mitre.org/techniques/T1070/) (Indicator Removal) | [`AML.T0015`](https://atlas.mitre.org/) (Evade ML Model) | [`D3-MTC`](https://d3fend.mitre.org/) (Message Authentication)<br>[`D3-HPA`](https://d3fend.mitre.org/) (Hardware Platform Auth) | **INV-01** (Telemetry Preservation)<br>Local NVMe ring buffer & mTLS with TPM attestation. | [ADR-0021](/adr/0021-graceful-degradation-automated-fallback-and-continuity-plan-b) |
| **THR-T2**: Schema Poisoning / DoS Inundation | **T / D** | [`T1565.002`](https://attack.mitre.org/techniques/T1565/002/) (Transmitted Data Manipulation)<br>[`T1499`](https://attack.mitre.org/techniques/T1499/) (Endpoint DoS) | [`AML.T0020`](https://atlas.mitre.org/) (Data Poisoning) | [`D3-SVE`](https://d3fend.mitre.org/) (Schema Validation)<br>[`D3-DLQ`](https://d3fend.mitre.org/) (Dead-Letter Queue Isolation) | **INV-01** (Telemetry Preservation)<br>Line-rate OCSF compiler validation & raw payload quarantine envelope. | [ADR-0002](/adr/0002-preserve-unmapped-telemetry-in-ocsf) |
| **THR-T3**: Evidence Tampering / Audit Destruction | **R / T** | [`T1070.003`](https://attack.mitre.org/techniques/T1070/003/) (Clear History)<br>[`T1485`](https://attack.mitre.org/techniques/T1485/) (Data Destruction) | [`AML.T0024`](https://atlas.mitre.org/) (ML Artifact Manipulation) | [`D3-WORM`](https://d3fend.mitre.org/) (Write-Once Media Storage)<br>[`D3-CH`](https://d3fend.mitre.org/) (Cryptographic Hash Verification) | **INV-02** (Evidence Traceability)<br>Immutable WORM lakehouse, RFC 3161 timestamps, Incident Decision DAG. | [ADR-0001](/adr/0001-record-architecture-decisions)<br>[ADR-0010](/adr/0010-sabsa-business-architecture-and-attribute-profiling) |
| **THR-T4**: Indirect Prompt Injection | **E / T** | [`T1059`](https://attack.mitre.org/techniques/T1059/) (Command Interpreter)<br>[`T1548`](https://attack.mitre.org/techniques/T1548/) (Abuse Elevation) | [`AML.T0051`](https://atlas.mitre.org/) (LLM Prompt Injection)<br>[`AML.T0057`](https://atlas.mitre.org/) (LLM Jailbreak) | [`D3-IT`](https://d3fend.mitre.org/) (Isolated Execution)<br>[`D3-LAM`](https://d3fend.mitre.org/) (Least-Privilege Access Mechanism) | **INV-04** (Authority Separation)<br>Agent Trust Boundary (dual-plane isolation) & read-only MCP tooling. | [ADR-0004](/adr/0004-defensive-ai-runtime-and-prompt-injection-firewall)<br>[ADR-0015](/adr/0015-sandboxed-agent-execution-otlp-convergence-and-ephemeral-identity) |
| **THR-T5**: Alert Storm DoS / Desensitisation | **D / T** | [`T1499.003`](https://attack.mitre.org/techniques/T1499/003/) (App Exhaustion Flood)<br>[`T1562`](https://attack.mitre.org/techniques/T1562/) (Impair Defenses) | [`AML.T0040`](https://atlas.mitre.org/) (Adversarial ML Perturbations) | [`D3-ARA`](https://d3fend.mitre.org/) (Alert Rate Anomaly Detection)<br>[`D3-BCA`](https://d3fend.mitre.org/) (Bayesian Correlation Analysis) | **INV-03** (Evidential Independence)<br>Dependency-aware Bayesian risk discounting & monthly SRE noise error budgets. | [ADR-0003](/adr/0003-graph-supernode-pruning-and-clustering-boundaries)<br>[ADR-0008](/adr/0008-secops-error-budgets-and-chaos-security-engineering)<br>[ADR-0009](/adr/0009-bayesian-multi-signal-risk-scoring) |
| **THR-T6**: Automated Response Sabotage | **D / E** | [`T1489`](https://attack.mitre.org/techniques/T1489/) (Service Stop)<br>[`T1562.001`](https://attack.mitre.org/techniques/T1562/001/) (Disable Tools) | [`AML.T0053`](https://atlas.mitre.org/) (Excessive Agency / Goal Hijacking) | [`D3-SMS`](https://d3fend.mitre.org/) (State Machine Security)<br>[`D3-BRC`](https://d3fend.mitre.org/) (Blast-Radius Constraint) | **INV-07** (Reachability Monotonicity)<br>Monotonic state machine ($s_{n+1} \preceq s_n$), Tier 0 immunity, master E-stop. | [ADR-0005](/adr/0005-saga-pattern-containment-and-break-glass-protocol) |
| **THR-T7**: Machine Token / SVID Hijacking | **E / S** | [`T1078.004`](https://attack.mitre.org/techniques/T1078/004/) (Cloud Accounts)<br>[`T1550.001`](https://attack.mitre.org/techniques/T1550/001/) (Application Access Token) | [`AML.T0047`](https://atlas.mitre.org/) (ML Artifact / Token Theft)<br>[`AML.T0054`](https://atlas.mitre.org/) (LLM Plugin Compromise) | [`D3-LAM`](https://d3fend.mitre.org/) (Least-Privilege Access Mechanism)<br>[`D3-MTC`](https://d3fend.mitre.org/) (Message Authentication) | **INV-05** (Least Capability)<br>SPIFFE/SPIRE dynamic task-scoped SVIDs ($\le 15\text{m}$) & line-rate NHI behavioral profiling. | [ADR-0015](/adr/0015-sandboxed-agent-execution-otlp-convergence-and-ephemeral-identity)<br>[ADR-0018](/adr/0018-non-human-identity-lifecycle-and-machine-attestation) |
| **THR-T8**: Model & Knowledge Base Poisoning | **T / I** | [`T1565.001`](https://attack.mitre.org/techniques/T1565/001/) (Stored Data Manipulation)<br>[`T1562.001`](https://attack.mitre.org/techniques/T1562/001/) (Disable Tools) | [`AML.T0018`](https://atlas.mitre.org/) (Data Poisoning)<br>[`AML.T0020`](https://atlas.mitre.org/) (Poison Training/RAG Data) | [`D3-CH`](https://d3fend.mitre.org/) (Cryptographic Hash Verification)<br>[`D3-DN`](https://d3fend.mitre.org/) (Decoy Network / Environment) | **INV-02** (Evidence Traceability)<br>WORM-sealed RAG context, SLM grounding judges ($\ge 95\%$), ambient canary anchors. | [ADR-0010](/adr/0010-sabsa-business-architecture-and-attribute-profiling)<br>[ADR-0013](/adr/0013-ambient-deception-fabric-and-canary-anchors)<br>[ADR-0014](/adr/0014-ai-observability-self-learning-and-slm-judges) |
| **THR-T9**: Excessive Agency & Output Leakage | **I / E** | [`T1005`](https://attack.mitre.org/techniques/T1005/) (Data from Local System)<br>[`T1499`](https://attack.mitre.org/techniques/T1499/) (Endpoint DoS) | [`AML.T0053`](https://atlas.mitre.org/) (Excessive Agency)<br>[`AML.T0043`](https://atlas.mitre.org/) (Insecure Output Handling) | [`D3-EOP`](https://d3fend.mitre.org/) (Execution Boundary / Sandbox)<br>[`D3-SLB`](https://d3fend.mitre.org/) (Semantic Loop Breaking) | **INV-06** (Bounded Autonomy)<br>Deterministic AST query validator, loop circuit breakers, financial execution caps. | [ADR-0004](/adr/0004-defensive-ai-runtime-and-prompt-injection-firewall)<br>[ADR-0012](/adr/0012-ai-orchestration-runtime-mcp-and-mvp-roadmap)<br>[ADR-0017](/adr/0017-agent-fleet-control-plane-and-runtime-observability) |
