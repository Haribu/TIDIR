...
| **Reliable** | Detection engineering maintains low operational friction and prevents analyst burnout. | Alert false positive rate $< 5\%$<br>Error budget burn $< 100\%$ | `DET-06`<br>`DET-05` | SRE Alert Noise Error Budgets ([ADR-0008](/adr/0008-secops-error-budgets-and-chaos-security-engineering.md)) and Bayesian multi-signal compounding ([ADR-0009](/adr/0009-bayesian-multi-signal-risk-scoring.md)). |
