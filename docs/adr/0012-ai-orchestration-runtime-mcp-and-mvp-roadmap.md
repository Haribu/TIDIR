...
- **Dual-Plane Prompt Injection Firewall:** Treats all telemetry payloads, email bodies, file paths, and external CTI as untrusted data planes. Instructions come exclusively from versioned, cryptographically hashed control prompts.
